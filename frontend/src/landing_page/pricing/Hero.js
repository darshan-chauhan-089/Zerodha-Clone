        ...
        <div className='container mt-5 mb-5 py-5'>
            ...
            <div className='row justify-content-center pt-5 mt-5 mb-3'>
                ...
                <div className="col-12 col-md-4 col-lg-3 text-center p-2">
                    <img className="" src="media/images/pricing0.svg" style={{width: "250px", height: "180px"}}></img>
                ...
                <div className="col-12 col-md-4 col-lg-3 text-center p-2">
                    <img className="" src="media/images/other-trades.svg" style={{width: "250px", height: "180px"}}></img>
                ...
                <div className="col-12 col-md-4 col-lg-3 text-center p-2">
                    <img className="" src="media/images/pricingMF.svg" style={{width: "250px", height: "180px"}}></img>
