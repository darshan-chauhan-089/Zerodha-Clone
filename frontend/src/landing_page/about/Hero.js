        ...
        <div className='container mb-5 mt-3'>
            <div className='row '>
                <div className='col-12 p-5'>
                    <h2 className="text-muted p-sm-5 text-center">
            ...
            <div className="row mb-5">
                    ...
                    <div className="col-lg-4">
                        ...
                        <p>
                            ...
                            latest updates on our blog or see what the media is saying about us or learn more about our business and product philosophies.
                        </p>
                    </div>
                    <div className="col-0 col-sm-2"></div>
